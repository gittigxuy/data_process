...
with open("outputval.json", "r+") as f:
    allData = json.load(f)
...
for single in img_all:
    ...
    file_path = '/home/xuy/桌面/code/python/challenageAI/bdd_dataset/images/images/100k'
...
#    io.imshow(img)
    ...
    xml_name = '/home/xuy/桌面/code/python/challenageAI/bdd_dataset/VOC_train_bak/'+data['filename'][:-4] + '.xml'
