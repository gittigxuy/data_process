...
class YOLO(object):
    def __init__(self):
        ...
        self.model_path = '/home/xuy/code/keras-yolo3-shirt_color/model_data/yolo.h5'  # 模型文件
        # self.classes_path = 'configs/coco_classes.txt'  # 类别文件
        self.classes_path = '/home/xuy/code/keras-yolo3-shirt_color/configs/voc_classes.txt'  # 类别文件
...
def detect_img_for_test(yolo):
    ...
    for img_path in iterbrowse(img_root_path):
        ...
        r_image = yolo.detect_image_pic(image)
