...
data = scipy.io.loadmat('/home/xuy/dataset/citypersons/shanshanzhang-citypersons/annotations/anno_train.mat')#fix
pic_train='/home/xuy/dataset/citypersons/leftImg8bit/train'#fix
...
txt_name = '/home/xuy/dataset/citypersons/result_csv/train.txt'#fix
f = open(txt_name, 'w')
for record in data:
...
#将txt文件转化为csv文件
import csv
with open('/home/xuy/dataset/citypersons/result_csv/val1.csv', 'w+',newline='') as csvfile:#fix
    spamwriter = csv.writer(csvfile, dialect='excel')
    # 读要转换的txt文件，文件每行各词间以@@@字符分隔
    with open('/home/xuy/dataset/citypersons/result_csv/val1.txt', 'r',encoding='utf-8') as filein:#fix
        for line in filein:
